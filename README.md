...
# 安装依赖
npm install --registry=https://art-internal.test.com/artifactory/api/npm/npm/
...
3. 在 env.py 中配置数据库信息
	...
	mysql数据库字符集：utf8mb4
4. 安装依赖环境
	pip3 install -r requirements.txt -i https://art-internal.test.com/artifactory/api/pypi/pypi/simple
5. 执行迁移命令：
