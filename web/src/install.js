...
Vue.prototype.commonEndColumns = function (param = {}) {
  ...
  const showData = {
    ...
    update_datetime: {
      ...
      showTable: (param.update_datetime && param.update_datetime.showTable) !== undefined ? param.update_datetime.showTable : false
    },
    creator_name: {
    ...
    create_datetime: {
      ...
      showTable: (param.create_datetime && param.create_datetime.showTable) !== undefined ? param.create_datetime.showTable : false
    }
  }
  return [
    {
